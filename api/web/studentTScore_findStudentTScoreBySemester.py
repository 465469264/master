    ...
    teststeps = [
        Step(
            RunRequest("获取学生的期末成绩")
                ...
                .with_jmespath("body.body[3].rewardScore", "rewardScore3")  # 学业奖励分
                .with_jmespath("body.body[3].totalRewardScore", "totalRewardScore3")  # 总分+奖励分
                .with_jmespath("body.body[3].teacher", "teacher3")  # 教师名字
                .with_jmespath("body.body[3].teacherId", "teacherId3")  # 教师ID
                .with_jmespath("body.body[3].advScore", "advScore3")  # 上进分
                .with_jmespath("body.body[3].usualTimeMark", "usualTimeMark3")  # 平时成绩
