    ...
    teststeps = [
        Step(
            RunRequest("获取地区")
                ...
                .with_data('$data')
                .extract()
                .with_jmespath("body.body[0].name", "districtName")
                .with_jmespath("body.body[0].code", "districtCode")
