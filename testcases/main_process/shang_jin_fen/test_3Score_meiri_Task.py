...
class Test_Score_meiri_Task(HttpRunner):
    ...
    teststeps = [
        ...
        Step(RunTestCase("上进分-判断“每日登录APP一次”任务已完成").with_variables(**({"a":"0","sort":1})).call(gsAwardInfos2).export(*["rewardType","ruleGroup","ruleCode1","id1","ruleCode2","id2","ruleCode3","id3","ruleCode4","id4"])),
        ...
        Step(RunTestCase("上进分-判断30分钟任务已完成").with_variables(**({"a": "1", "sort": 1})).call(gsAwardInfos2))
