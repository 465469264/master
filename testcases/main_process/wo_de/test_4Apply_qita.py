...
class Test_Apply_qita(HttpRunner):
    ...
    teststeps = [
        Step(RunTestCase("登录申请其他证明的手机号").call(app_login).export(*["app_auth_token","userId"])),
        ...
        Step(RunTestCase("申请其他证明").with_variables(**({"checkStatus":"","stdName": "$std_name", "userId": "$unvsId", "applyType": "5", "remark": "测试", "applyPurpose": "测试","receiveType": "1", "unvsName": "",
