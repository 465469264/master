...
class Test_Read_habbit(HttpRunner):
    ...
    teststeps = [
        ...
        Step(RunTestCase('发布帖子至读书社不带图片').with_variables(**({"scType": "2", "subType": "0", "scPicUrl": "$scPicUrl", "scText": "Amylee-自动发帖-带图片-至读书社"})).call(usNewPosting)),
        Step(RunTestCase('发布帖子至跑团不带图片').with_variables(**({"scType": "3", "subType": "0", "scPicUrl": "", "scText": "Amylee-自动发帖-不带图片-至跑团"})).call(usNewPosting)),
        ...
        Step(RunTestCase('发布帖子至自考圈不带图片').with_variables(**({"scType": "4", "subType": "0", "scPicUrl": "", "scText": "Amylee-自动发帖-不带图片-至自考圈"})).call(usNewPosting)),
        ...
        Step(RunTestCase('发布帖子至同学圈不带图片').with_variables(**({"scType": "1", "subType": "0", "scPicUrl": "", "scText": "Amylee-自动发帖-不带图片-至同学圈"})).call(usNewPosting)),
